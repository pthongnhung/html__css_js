...
do {
    ...
    switch (choice) {
        ...
        case 3:
            ...
            arr.sort((a, b) => b - a);
            flag
                ? console.log("Tổng của tất cả số chẵn trong mảng là " + sum)
                : console.log("Trong mảng không có số chẵn.");
            console.log(arr);
            break;
        ...
        case 4:
            if (arr.length === 0) {
                ...
                console.log(
                    `Giá trị lớn nhất: ${sortedArr[sortedArr.length - 1]} vị trí :${sortedArr.length - 1
                    }, Giá trị nhỏ nhất: ${sortedArr[0]} vị trí :0`
                );
            }
            break;
        ...
        case 5:
            ...
            primeNumbers.length > 0
                ? console.log("Số nguyên tố trong mảng:", primeNumbers, "Tổng:", sum)
        ...
        case 8:
            ...
            flag
                ? console.log(`phần tử bạn muốn xóa đã đc xóa khỏi mảng`)
                : console.log(`phần tử bạn muốn xóa không có trong mảng`);
            break;
        case 9:
            let choice2;
            do {
                ...
                switch (choice2) {
                    ...
                    case 2:
                        arr.sort((a, b) => b - a);
                        arr.length > 0
                            ? console.log("mảng của bạn đã đc xắp xếp")
                            : console.log("mảng của bạn không có phần tử để xắp xếp");
                        break;
                    default:
